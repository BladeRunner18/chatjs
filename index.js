    ...
    if (MsgType === "text") {
        if (Content === "回复文字") {
            ...
            await sendmess(appid, {
                ...
                image: {
                    media_id:
                        "P-hoCzCgrhBsrvBZIZT3jx1M08WeCCHf-th05M4nac9TQO8XmJc5uc0VloZF7XKI",
                },
            });
            ...
            await sendmess(appid, {
                ...
                voice: {
                    media_id:
                        "06JVovlqL4v3DJSQTwas1QPIS-nlBlnEFF-rdu03k0dA9a_z6hqel3SCvoYrPZzp",
                },
            });
            ...
            await sendmess(appid, {
                ...
                video: {
                    media_id:
                        "XrfwjfAMf820PzHu9s5GYsvb3etWmR6sC6tTH2H1b3VPRDedW-4igtt6jqYSBxJ2",
                    title: "微信云托管官方教程",
            ...
            await sendmess(appid, {
                ...
                music: {
                    ...
                    HQ_music_url:
                        "https://c.y.qq.com/base/fcgi-bin/u?__=0zVuus4U",
                    thumb_media_id:
                        "XrfwjfAMf820PzHu9s5GYgOJbfbnoUucToD7A5HFbBM6_nU6TzR4EGkCFTTHLo0t",
                },
            });
